...
/// Variadic function bindings for libvips API package.
///
/// api 包自己的可变参数函数绑定。
class VipsApiBindings {
  final ffi.DynamicLibrary _lib;

  VipsApiBindings(this._lib);
  ...
  late final _vipsReduce = _lib
      .lookup<ffi.NativeFunction<VipsReduceNative>>('vips_reduce')
      .asFunction<VipsReduceDart>();

  late final _vipsShrink = _lib
      .lookup<ffi.NativeFunction<VipsShrinkNative>>('vips_shrink')
      .asFunction<VipsShrinkDart>();
  ...
  int reduce(
    ...
    return _vipsReduce(in1, out, hshrink, vshrink, ffi.nullptr);
  }
  ...
  int shrink(
    ...
    return _vipsShrink(in1, out, hshrink, vshrink, ffi.nullptr);
  }
  ...
  late final _vipsZoom = _lib
      .lookup<ffi.NativeFunction<VipsZoomNative>>('vips_zoom')
      .asFunction<VipsZoomDart>();
  ...
  int zoom(
    ...
    return _vipsZoom(in1, out, xfac, yfac, ffi.nullptr);
  }
  ...
  late final _vipsSobel = _lib
      .lookup<ffi.NativeFunction<VipsSobelNative>>('vips_sobel')
      .asFunction<VipsSobelDart>();

  late final _vipsCanny = _lib
      .lookup<ffi.NativeFunction<VipsCannyNative>>('vips_canny')
      .asFunction<VipsCannyDart>();
  ...
  int sobel(
    ...
    return _vipsSobel(in1, out, ffi.nullptr);
  }
  ...
  int canny(
    ...
    return _vipsCanny(in1, out, ffi.nullptr);
  }
  ...
  late final _vipsExtractBand = _lib
      .lookup<ffi.NativeFunction<VipsExtractBandNative>>('vips_extract_band')
      .asFunction<VipsExtractBandDart>();
  ...
  int extractBand(
    ...
    return _vipsExtractBand(in1, out, band, ffi.nullptr);
  }
  ...
  late final _vipsJoin = _lib
      .lookup<ffi.NativeFunction<VipsJoinNative>>('vips_join')
      .asFunction<VipsJoinDart>();

  late final _vipsComposite2 = _lib
      .lookup<ffi.NativeFunction<VipsComposite2Native>>('vips_composite2')
      .asFunction<VipsComposite2Dart>();
  ...
  int join(
    ...
    return _vipsJoin(in1, in2, out, direction, ffi.nullptr);
  }
  ...
  int composite2(
    ...
    return _vipsComposite2(base, overlay, out, mode, ffi.nullptr);
  }
  ...
  late final _vipsText = _lib
      .lookup<ffi.NativeFunction<VipsTextNative>>('vips_text')
      .asFunction<VipsTextDart>();

  late final _vipsGaussnoise = _lib
      .lookup<ffi.NativeFunction<VipsGaussnoiseNative>>('vips_gaussnoise')
      .asFunction<VipsGaussnoiseDart>();

  late final _vipsXyz = _lib
      .lookup<ffi.NativeFunction<VipsXyzNative>>('vips_xyz')
      .asFunction<VipsXyzDart>();

  late final _vipsGrey = _lib
      .lookup<ffi.NativeFunction<VipsGreyNative>>('vips_grey')
      .asFunction<VipsGreyDart>();
  ...
  int text(
    ...
    return _vipsText(out, text, ffi.nullptr);
  }
  ...
  int gaussnoise(
    ...
    return _vipsGaussnoise(out, width, height, ffi.nullptr);
  }
  ...
  int xyz(
    ...
    return _vipsXyz(out, width, height, ffi.nullptr);
  }
  ...
  int grey(
    ...
    return _vipsGrey(out, width, height, ffi.nullptr);
  }
}
